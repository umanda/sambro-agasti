...
<table>
	...
	<tbody>
		...
		<tr>
			<td rowspan=2><?php echo _('Long Text');?></td>
			<td><?php echo _('Email');?></td>
		...
		<tr>
			<td rowspan=3><?php echo _('Voice Text');?></td>
		...
		<tr>
			<td><?php echo _('Satellite');?></td>
                        <td><input type="checkbox" name="select_type[]" id="select[]" value="voice_to_satellite"/></td>
		</tr>
	</tbody>
</table>
<?php 
